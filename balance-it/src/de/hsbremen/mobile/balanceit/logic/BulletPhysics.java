...
/**
 * Calculates physics using the BulletPhysics engine.
 */
public class BulletPhysics implements Physics {
	...
	/* (non-Javadoc)
	 * @see de.hsbremen.mobile.balanceit.logic.Physics#setUp(float, float, float)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.hsbremen.mobile.balanceit.logic.Physics#initSphere(com.badlogic.gdx.math.Matrix4)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.hsbremen.mobile.balanceit.logic.Physics#initGround(com.badlogic.gdx.math.Matrix4)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.hsbremen.mobile.balanceit.logic.Physics#update(float)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.hsbremen.mobile.balanceit.logic.Physics#getSphereTransform()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.hsbremen.mobile.balanceit.logic.Physics#resetSphere(com.badlogic.gdx.math.Matrix4)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.hsbremen.mobile.balanceit.logic.Physics#setGroundTransform(com.badlogic.gdx.math.Matrix4)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.hsbremen.mobile.balanceit.logic.Physics#applyForceToSphere(com.badlogic.gdx.math.Vector3)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.hsbremen.mobile.balanceit.logic.Physics#dispose()
	 */
	@Override
	public void dispose() {
		if (groundShape != null)
